public class FieldImpl implements Field {
    ...
    public FieldImpl(Integer fieldSize, CellBuilder cellBuilder) {
        ...
        // corners
        cells[0][0] = cellBuilder.buildCell(CellType.NONE);
        cells[fieldSize - 1][fieldSize - 1] = cellBuilder.buildCell(CellType.NONE);
        cells[0][fieldSize - 1] = cellBuilder.buildCell(CellType.NONE);
        cells[fieldSize - 1][0] = cellBuilder.buildCell(CellType.NONE);
        ...
        // 2
        for (int i = 1; i < fieldSize - 1; ++i) {
            cells[0][i] = cellBuilder.buildCell(CellType.NONE);
            cells[fieldSize - 1][i] = cellBuilder.buildCell(CellType.NONE);
            cells[i][0] = cellBuilder.buildCell(CellType.NONE);
            cells[i][fieldSize - 1] = cellBuilder.buildCell(CellType.NONE);
        }
